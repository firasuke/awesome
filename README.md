...
from source code
- [METALOS](https://codeberg.org/DAFT-8/METALOS): A meta-Linux distribution
...
- [Shebang](https://shebang-linux.github.io/): An Artix GNU/Linux based
distribution that uses the runit init system and the Openbox window manager
